<template>
    <div class="newbooksinstorage" v-if="this.radios==1">
        <account/>
        <div class="seven">
            <div class="nav">
                <ul>
        ...
        <div class="newbooksinstorage-body">
            <warehousing/>
            <!-- <buttom/> -->
        </div>
    </div>
...
import warehousing from '../components/administrators/warehousing.vue'
