<template>
    <div class="newbookshelves" v-if="this.radios==1">
        <account/>
        <div class="seven">
            <div class="nav">
                <ul>
                    ...
                    <nuxt-link to="/administrators"><li class="index7">管理员</li></nuxt-link>
                </ul>
            </div>
        </div>
        <div class="newbookshelves-body">
            <uppershelf :listb="listb"/>
            <!-- <buttom/> -->
        </div>
    </div>
</template>
...
import uppershelf from '../components/administrators/uppershelf.vue'
...
export default {
    ...
    async asyncData(ctx) {
        try{
            const {data:{list}} = await ctx.$axios.post('/newbookshelves/messagelist')
...
.seven .index2:hover ul li:hover{
...
.seven .index3:hover ul li:hover{
    background: rgb(255, 200, 0);
}
.seven .index4 ul li{
    position: relative;
...
.seven .index4:hover ul li:hover{
    background: rgb(255, 200, 0);
}
.seven .index5 ul li{
    position: absolute;
...
.seven .index5:hover ul li:hover{
    background: rgb(255, 200, 0);
}
.seven .newbookshelves-body{
    position: absolute;
    z-index: 2;
    width: 100%;
}
