...
import result from '../components/retrieval/result.vue'
export default {
    components: {
        account,
        result,
...
.three-search .nav li:hover{
    background: rgba(255, 51, 0, 0.815);
}
.three-search .nav:hover .index3{
    background:none;
}
.three-search .nav .index3{
    background: rgba(255, 51, 0, 0.815);
}
.three-search .nav .index3:hover{
    background: rgba(255, 51, 0, 0.815);
}
.index2 ul li{
    position: relative;
