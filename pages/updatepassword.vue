<template>
    <div class="mylibrary" v-if="this.radios==0">
        ...
        <div class="mylibrary-informat">
            <template>
                <div class="index7_2" style="overflow: hidden;">
                    <ul>
                        <li>
                            <div class="aboutme_position">
                                <i class="el-icon-add-location"></i>当前位置 > 我的图书馆 > 修改密码
                            </div>
                            <div class="about_index7_1" style="float:left">
                                ...
                                <div class="listname">
                                    ...
                                    <div>
                                        <a href="/updatepassword"><el-button style="color: #CD3339;"><i class="el-icon-arrow-right"></i> 修改密码</el-button></a>
                                    </div>
                                    <div>
                                ...
                                <div class="listbook">
                                    <div>&nbsp;&nbsp;&nbsp;旧密码：<el-input v-model="pass"  show-password></el-input></div>
                                    <div>&nbsp;&nbsp;&nbsp;新密码：<el-input v-model="newpass1" size="medium"  show-password></el-input></div>
                                    <div>确认密码：<el-input v-model="newpass2" size="medium"  show-password></el-input></div>
                                    <div style="margin-left:10px;text-indent: 5em"><el-button type="primary" size="small" @click="updatepassword()">确认修改</el-button></div>
                                </div>
                            </div>
                        </li>
                    </ul>
    ...
    methods:{
        updatepassword:async function(){
            if(this.pass==''){
                ...
                let self = this;
                let {status,data:{list}} = await self.$axios.post('/mylibrary/updatepassword', 
                {user_account:self.username,old_password:self.pass,new_password:self.newpass1,new_cpassword:self.newpass2})
                if(list.status==0){
                    this.$alert('修改成功', {
