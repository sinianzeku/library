<template>
    <div class="detailedcontent">
        <account/>
        <div class="three-detailedcontent"> 
            <div class="nav">
                <ul>
        ...
        <div class="detailedcontent-body">
            <bookinformation/>
        </div>
    </div>
</template>
...
import bookinformation from '../components/retrieval/bookinformation.vue'
export default {
    components: {
        account,
        bookinformation,
    ...
    // created: function () {
    //     this.index3 = this.$route.query.index3;
...
.three-detailedcontent{
    height: 60px;
    background: rgb(240, 240, 240);
}
.three-detailedcontent .nav{
    margin-left: 5%;
    position: relative;
    z-index: 3; 
}
.three-detailedcontent .nav li{
    float: left;
    width: 13.07%;
    text-align: center;
    list-style: none;
...
.three-detailedcontent .nav li:hover{
    background: rgba(255, 51, 0, 0.815);
}
.three-detailedcontent .nav:hover .index3{
    background:none;
}
.three-detailedcontent .nav .index3{
    background: rgba(255, 51, 0, 0.815);
}
.three-detailedcontent .nav .index3:hover{
    background: rgba(255, 51, 0, 0.815);
}
.index2 ul li{
    position: relative;
